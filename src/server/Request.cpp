...
namespace
{
	bool isRecognizedMethod(const std::string& str);
	bool isRecognizedVersion(const std::string& str);
	bool parseUri(std::string& uri, std::string& domain, int& port);
	bool isOriginForm(const std::string& uri);
	bool processAbsoluteForm(std::string& uri, std::string& domain, int& port);
	bool setScheme(const std::string& uri, std::string& scheme);
	bool setPath(const std::string& uri, const std::string& scheme,
		std::string& path);
	bool setDomainAndPort(const std::string& uri, const std::string& scheme,
		std::string& domain, std::string& str_port);
	int parsePort(const std::string& port, const std::string& scheme);
...
namespace
{
	bool isRecognizedMethod(const std::string& str)
	{
		return str == "GET" || str == "HEAD" || str == "POST"
			|| str == "DELETE";
	}
